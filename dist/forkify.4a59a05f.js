...
const controlRecipes = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).update(_modalJs.getSearchResultPage());
        await _modalJs.loadRecipe(id);
        // console.log(recipe);
        (0, _recipeViewJsDefault.default).render(_modalJs.state.recipe);
        (0, _bookmarkViewJsDefault.default).update(_modalJs.state.bookmarks);
    } catch (err) {
        // alert(err);
...
const controlsearchResults = async function() {
    try {
        ...
        (0, _searchViewJsDefault.default).getQuery();
        (0, _resultsViewJsDefault.default).render(_modalJs.getSearchResultPage());
...
const controlPagination = function(goToPage) {
    (0, _resultsViewJsDefault.default).render(_modalJs.getSearchResultPage(goToPage));
    (0, _paginationViewJsDefault.default).render(_modalJs.state.search);
};
const controlServing = async function(newServings) {
    await _modalJs.updateServings(newServings);
...
const controlAddBookmark = function() {
    ...
    (0, _recipeViewJsDefault.default).update(_modalJs.state.recipe);
    (0, _bookmarkViewJsDefault.default).render(_modalJs.state.bookmarks);
};
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandelerUpdateServing(controlServing);
    (0, _recipeViewJsDefault.default).addHandelerAddBookMark(controlAddBookmark);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./modal.js":"jJ31c","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","./views/paginationView.js":"7NIiB","./views/bookmarkView.js":"jPLC7","./views/addRecipeView.js":"8AWnP","./config.js":"2hPh4"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
const API_KEY = "25fd3f8b-118d-42e9-804d-89ddb3141801";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandelerUpdateServing(handler) {
    ...
    <figure class="recipe__fig">
        ...
        <div class="recipe__ingredients">
          ...
          ${this._data.ingredients.map(this._generateMarkupIngreditants).join("")}            
          </ul>
        </div>
    ...
    _generateMarkupIngreditants(ing) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","fraction.js":"md6n5"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu"}],"md6n5":[function(require,module,exports,__globalThis) {
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./View.js":"jSw21"}],"kBQ4r":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        `;
        else if (this._data.page === numPages && numPages > 1) return `
      ...
      `;
        else if (this._data.page < numPages) return `
        <button data-goto="${this._data.page - 1}" class="btn--inline pagination__btn--prev">
          <svg class="search__icon">
            <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
          </svg>
...
},{"./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu"}],"jPLC7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
